...
SECRET_KEY = 'django-insecure-o*5n&b2@csn34r2jik)#83^%*5n34z73z$53ws@)fwp-x$u-n1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # This points to the global templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Adjust if using a custom directory
]
...
# URL to access media files (uploaded files)
MEDIA_URL = '/media/'
